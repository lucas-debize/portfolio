...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    en: {
      ...
      "contact-intro": "For any more information or inquiries, feel free to reach out to my CV or contact me directly.",
      "contact-phone": "Phone: +33 07 82 75 92 01",
      "contact-email": "Mail: lucas.debize@epitech.eu",
    ...
    fr: {
      ...
      "contact-intro": "Pour plus d'informations ou toute demande, n'hésitez pas à consulter mon CV ou à me contacter directement.",
      "contact-phone": "Téléphone : +33 07 82 75 92 01",
      "contact-email": "Mail : lucas.debize@epitech.eu",
      "form-name-label": "Nom",
